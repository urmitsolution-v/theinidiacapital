            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Create Page Setting</h4>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" name="pagename"
                                                    value="{{ old('pagename') }}" class="form-control">
                                                @error('pagename')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" name="bradcump_title"
                                                    value="{{ old('bradcump_title') }}" class="form-control">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" name="tag"
                                                    value="{{ old('tag') }}" class="form-control">
                                                @error('tag')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="meta_d" class="form-control" cols="30" rows="3"></textarea>
                                                @error('meta_d')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
