        ...
        <div class="container-fluid">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Partners</h4>
                </div>
                <div class="text-end">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/create-partners" role="button">Add</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure !')"
                                                href="{{ route('deletegallery', ['table' => 'gallery', 'id' => $item->id, 'image' => $image]) }}"
                                                class="text-danger">
