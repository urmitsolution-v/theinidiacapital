        ...
        <div class="container-fluid">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">{{ $_GET['type'] }} Categories</h4>
                </div>

                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item active">{{ $_GET['type'] }} Categories</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/new-categories?type=<?= $_GET['type'] ?>"
                                role="button">Add</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure !')"
                                                    href="{{ route('deleterownew', ['table' => 'category', 'id' => $item->id, 'image' => $image]) }}"
                                                    class="text-danger">
                                                ...
                                                <a href="/admin/edit-category/{{ $item->id }}?type=<?= $_GET['type'] ?>"
                                                    class="text-primary">
                                                    <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24" fill="currentColor">
                                                        <path
