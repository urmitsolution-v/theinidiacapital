@section('title', 'Dashboard - Access Management')
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Access Management</h4>
                </div>
                <div class="text-end">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/new-access" role="button">Add</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($item->role_type == "billing"){
                                                    echo "Billing Counter";
                                                }elseif($item->role_type == "receptionist"){
                                                    echo "Sales";
                                                }elseif ($item->role_type == "cutting_master") {
                                                    echo "Cutting Master";
                                                }elseif ($item->role_type == "workshop") {
                                                    echo "Workshop";
                                                }elseif ($item->role_type == "admin") {
                                                    echo "Admin";
                                                }else{
                                                    echo "";
                                                } ?>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure !')"
                                                    href="{{ route('deleterownew', ['table' => 'users', 'id' => $item->id, 'image' => $image]) }}"
                                                    class="text-danger">
                                                ...
                                                <a href="/admin/edit-accessm-anagement/{{ $item->id }}" class="text-primary">
                                                    <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24" fill="currentColor">
                                                        <path
