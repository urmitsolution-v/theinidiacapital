            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Create Service</h4>
                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="category" id="example-select">
                                                    ...
                                                    $categories = DB::table('category')
                                                        ->where('status', 'Y')->where('type', 'service') ->get(['id', 'title']);
                                        ...
                                        {{-- <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" accept="image/*" id="simpleinput" name="baner_img"
                                                    value="{{ old('baner_img') }}" class="form-control">
                                                @error('baner_img')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="long_description" id="summernote" class="form-control" cols="30" rows="3"></textarea>
                                            </div>
                                        </div>
