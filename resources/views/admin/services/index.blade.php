                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/add-services" role="button">Add</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($Service as $key => $item)
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            <td>{{ $item->title}}</td>
                                            <td>{{ substr($item->long_description, 0, 20) }}..</td>
                                            <td>
                                                <img src="/Service-image/{{ $item->image }}"
                                                    class="dyanamic_image" loading="lazy" alt="">
                                            </td>
                                            <td>
                                                <img src="/Service-image/{{ $item->icon }}"
                                                    class="dyanamic_image" loading="lazy" alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure !')"
                                                    href="{{ route('services-delete', ['table' => 'banners', 'id' => $item->id, 'image' => $image]) }}"
                                                    class="text-danger">
