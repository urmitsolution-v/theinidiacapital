            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Edit Teams</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">Teams Details</h5>
                            </div><!-- end card header -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                @if($team->image)
                                                    <div class="mt-2">
                                                        <img src="{{ asset('team-image/' . $team->image) }}" alt="Image" style="width: 100px;">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
        ...
        <div class="d-flex">
            ...
            <div class="form-check">
                <input 
                    ...
                    name="status" 
                    id="gridRadios1" 
                    {{ old('status', $team->status) == 'Y' ? 'checked' : '' }}>
            ...
            <div class="form-check ms-3">
                <input 
                    ...
                    name="status" 
                    id="gridRadios2" 
                    {{ old('status', $team->status) == 'N' ? 'checked' : '' }}>
