                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/create-team" role="button">Add</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure !')"
                                                href="{{ route('deleteteam', ['table' => 'banners', 'id' => $item->id, 'image' => $image]) }}"
                                                class="text-danger">
