                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/create-blog" role="button">Add</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($blog as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{ substr($item->short_description, 0, 20) }}..</td>
                                            <td>{{ $item->admin }} </td>
                                            <td>
                                          <img src="{{ url('uploads') }}/{{ $item->image }}"  class="dyanamic_image" loading="lazy" alt="">
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure !')"
                                                    href="{{ route('deleterownew', ['table' => 'blogs', 'id' => $item->id, 'image' => $image]) }}"
                                                    class="text-danger">
