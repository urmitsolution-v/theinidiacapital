                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="simpleinput" class="form-label">Admin By</label>
                                                <input type="text" id="simpleinput" name="admin"
                                                    value="{{ $blog->admin }}" class="form-control">
                                                @error('admin')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" accept="image/*" id="simpleinput" name="banner"
                                                    value="{{ $blog->banner }}" class="form-control">
                                                @error('banner')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                                ...
                                                @if (isset($blog->banner))
                                                    <div class="uploaded_image">
                                                        <img src="{{ url('uploads') }}/{{ $blog->banner }}" alt=""
                                                            loading="lazy">
                                                    </div>
                                                @endif
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" accept="image/*" id="simpleinput" name="image"
                                                    value="{{ $blog->image }}" class="form-control">
                                                @error('image')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="category" id="example-select">
                                                    <?php
                                                    $categories = DB::table('category')->where('status', 'Y')->where('type', 'blogs')->get(['id', 'title']);
                                                    foreach ($categories as $key => $value) {
                                                    ?>


                                                    <option value="{{ $value->id }}"
                                                        <?= $value->id == $blog->category ? 'selected' : '' ?>>
                                                        {{ $value->title }}</option>
                                                    <?php } ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="short_description" class="form-control" cols="30" rows="3">{{ $blog->short_description }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="summernote" class="form-control" cols="30" rows="3">{{ $blog->description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="meta_description" class="form-control" cols="30" rows="3">{{ $blog->meta_description }}</textarea>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="form-check">
                                                        <input 
                                                            ...
                                                            name="status" 
                                                            id="gridRadios1" 
                                                            {{ old('status', $blog->status) == 'Y' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check ms-3">
                                                        <input 
                                                            ...
                                                            name="status" 
                                                            id="gridRadios2" 
                                                            {{ old('status', $blog->status) == 'N' ? 'checked' : '' }}>
