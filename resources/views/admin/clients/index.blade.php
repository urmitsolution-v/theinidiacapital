                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="/admin/create-clients" role="button">Add</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure !')"
                                                href="{{ route('deleteclients', ['table' => 'clients', 'id' => $item->id, 'image' => $image]) }}"
                                                class="text-danger">
                                            ...
                                            <a href="/admin/edit-clients/{{ $item->id }}" class="text-primary">
                                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24" fill="currentColor">
                                                    <path
