            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Edit Clients</h4>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                @if($clients->image)
                                                    <div class="mt-2">
                                                        <img src="{{ asset('uploads/' . $clients->image) }}" alt="Image" style="width: 100px;">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex">
                                                    <div class="form-check">
                                                        <input class="form-check-input" value="Y" name="status"
                                                            ...
                                                            @if ($clients->status == 'Y') checked="" @endif>
                                                    ...
                                                    <div class="form-check ms-3">
                                                        <input class="form-check-input" value="N" name="status"
                                                            ...
                                                            @if ($clients->status == 'N') checked="" @endif>
