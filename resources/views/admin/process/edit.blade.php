            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Edit Process</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">Process Details</h5>
                            </div><!-- end card header -->
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" name="title"
                                                    value="{{ $process->title }}" class="form-control">
                                                @error('title')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" name="sub_title"
                                                    value="{{ $process->sub_title }}" class="form-control">
                                                @error('sub_title')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @enderror
                                            @if ($process->icon)
                                                <img src="{{ url('uploads') }}/<?=$process->icon?>" width="100" class="img-thumblain" alt="">
                                            @endif
                                            </div>
                                        </div>
